...
export default function CardProfileFull({
  ...
  let colorClass = {
    ...
    teal: "text-teal-500 bg-teal-400",
    cyan: "text-cyan-500 bg-cyan-400",
  ...
  return (
    <>
      <div className="rounded-lg py-3 px-3 relative flex flex-col min-w-0 break-words bg-white w-full">
        ...
        <div className="px-0 py-1 flex-auto">
          <h3 className="text-2xl font-bold">{title}</h3>
          <p className="text-sm mt-1 mb-3 text-blueGray-400 font-bold uppercase">
            {description}
          </p>
